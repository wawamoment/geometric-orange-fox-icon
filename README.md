...
Main
![the icon](georangefox_alt.svg)
Alt
- These are original geometric fox terminal icons, drawn using Inkscape, from scratch. They are inspired from Kit, Firefox's mascot.
